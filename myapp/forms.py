...
class SampleForm(forms.Form):
    ...
    phno=forms.IntegerField(max_value=999999999,min_value=60000000000,required=True,label="Phone Number",help_text="no country code")
    #phno=forms.RegexField(max_length=10,min_length=10,required=True,required=True,regex=r'[6-9]\d{9}')
